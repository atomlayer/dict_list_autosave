...
setup(
    ...
    url='https://github.com/atomlayer/dict_list_autosave',
    download_url='https://github.com/atomlayer/dict_list_autosave/archive/main.zip',

    license='GNU AFFERO GENERAL PUBLIC LICENSE Version 3, 19 November 2007, see LICENSE file',

    packages=['dict_list_autosave'],
    install_requires=[],
